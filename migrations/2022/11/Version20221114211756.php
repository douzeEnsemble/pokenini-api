...
final class Version20221114211756 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE trainer_dex (id UUID NOT NULL, dex_id UUID DEFAULT NULL, trainer_external_id VARCHAR(255) NOT NULL, is_private BOOLEAN NOT NULL, is_on_home BOOLEAN NOT NULL, PRIMARY KEY(id))');
