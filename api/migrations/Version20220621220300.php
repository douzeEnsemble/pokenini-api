...
final class Version20220621220300 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        $this->insertDexes([
            ...
            'RedFire, LeafGreen' => "(p.bankable or p.bankableish) and p.specialForm?.name != 'Event'  and ba?.redfireleadgreen",
            'Diamond, Pearl, Platinium' => "(p.bankable or p.bankableish) and p.specialForm?.name != 'Event'  and ba?.diamonrdpearlplatinium",
